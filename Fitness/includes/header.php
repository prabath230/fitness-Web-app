            ...
            <?php if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] == true ) : ?>
                <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="">Fitness Admin</a>
                    </div>
                    <!-- /.navbar-header -->
                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li <?php echo (CURRENT_PAGE =="customers.php" || CURRENT_PAGE=="add_customer.php") ? 'class="active"' : '' ; ?>>
                                 ...
                                 <li <?php echo (CURRENT_PAGE =="staff.php" || CURRENT_PAGE=="add_staff.php") ? 'class="active"' : '' ; ?>>
                                    ...
                                    <li>
                                        <a href="add_staff.php"><i class="fa fa-plus fa-fw"></i>Add New</a>
                                    </li>
                                        </ul> 
                                <li>
